   ...
   post {
	failure {
           slackSend(
             ...
             color: "danger",
             message: "activiti-cloud-identity-chart branch=$BRANCH_NAME is failed http://jenkins.jx.35.228.195.195.nip.io/job/Activiti/job/activiti-cloud-identity-chart/"
           )
        }    
	always {
          cleanWs()
