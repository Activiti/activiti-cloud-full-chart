...
| activiti-cloud-connector.image.tag | string | `"7.9.0-alpha.21"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.9.0-alpha.21"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.9.0-alpha.21"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.9.0-alpha.21"` |  |
...
| runtime-bundle.image.tag | string | `"7.9.0-alpha.21"` |  |
