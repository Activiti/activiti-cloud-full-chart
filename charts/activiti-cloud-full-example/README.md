...
| activiti-cloud-connector.image.tag | string | `"7.1.995"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.1.995"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.1.995"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.995"` |  |
