...
![Version: 22.2.0-alpha.4](https://img.shields.io/badge/Version-22.2.0--alpha.4-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"22.2.0-alpha.4"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"22.2.0-alpha.4"` |  |
...
| activiti-cloud-query.image.tag | string | `"22.2.0-alpha.4"` |  |
...
| runtime-bundle.image.tag | string | `"22.2.0-alpha.4"` |  |
