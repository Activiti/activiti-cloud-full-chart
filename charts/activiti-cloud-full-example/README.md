...
![Version: 8.6.0-alpha.15](https://img.shields.io/badge/Version-8.6.0--alpha.15-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 8.6.0-alpha.7 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 8.6.0-alpha.7 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 8.6.0-alpha.7 |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 8.6.0-alpha.7 |
...
| activiti-cloud-connector.image.tag | string | `"8.6.0-alpha.9"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.6.0-alpha.9"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.6.0-alpha.9"` |  |
...
| runtime-bundle.image.tag | string | `"8.6.0-alpha.9"` |  |
