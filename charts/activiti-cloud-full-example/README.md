...
![Version: 7.1.1103](https://img.shields.io/badge/Version-7.1.1103-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.1.29 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.1.29 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.1.29 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.1.29 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.1.29 |
...
| activiti-cloud-connector.image.tag | string | `"7.1.1103"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.1.1103"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.1.1103"` |  |
...
| global.messaging.broker | string | `"kafka"` | required messaging broker, rabbitmq or kafka |
| global.messaging.partitionCount | int | `4` | configures number of partitioned consumers |
| global.messaging.partitioned | bool | `true` | enables partitioned messaging in combination with common chart values messaging.enabled=true and messaging.role=producer|consumer |
