...
![Version: 8.5.0-alpha.4](https://img.shields.io/badge/Version-8.5.0--alpha.4-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.5.0-alpha.4"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.5.0-alpha.4"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.5.0-alpha.4"` |  |
...
| runtime-bundle.image.tag | string | `"8.5.0-alpha.4"` |  |
