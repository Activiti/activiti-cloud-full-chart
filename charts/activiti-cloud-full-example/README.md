...
| activiti-cloud-connector.image.tag | string | `"7.1.0-SNAPSHOT"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.1.0-SNAPSHOT"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.1.0-SNAPSHOT"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.0-SNAPSHOT"` |  |
