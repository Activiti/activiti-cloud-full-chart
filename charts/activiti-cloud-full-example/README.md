...
![Version: 8.3.0-alpha.21](https://img.shields.io/badge/Version-8.3.0--alpha.21-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.3.0-alpha.21"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.3.0-alpha.21"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.3.0-alpha.21"` |  |
...
| runtime-bundle.image.tag | string | `"8.3.0-alpha.21"` |  |
