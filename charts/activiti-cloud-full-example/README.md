...
| activiti-cloud-connector.image.tag | string | `"8.6.0-alpha.6"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.6.0-alpha.6"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.6.0-alpha.6"` |  |
...
| runtime-bundle.image.tag | string | `"8.6.0-alpha.6"` |  |
