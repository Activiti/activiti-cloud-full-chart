...
![Version: 8.5.0-alpha.7](https://img.shields.io/badge/Version-8.5.0--alpha.7-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.5.0-alpha.7"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.5.0-alpha.7"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.5.0-alpha.7"` |  |
...
| runtime-bundle.image.tag | string | `"8.5.0-alpha.7"` |  |
