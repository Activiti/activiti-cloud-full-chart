...
![Version: 8.1.0-alpha.13](https://img.shields.io/badge/Version-8.1.0--alpha.13-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.1.0-alpha.13"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.1.0-alpha.13"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.1.0-alpha.13"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.1.0-alpha.13"` |  |
...
| runtime-bundle.image.tag | string | `"8.1.0-alpha.13"` |  |
