...
![Version: 22.2.0-alpha.18](https://img.shields.io/badge/Version-22.2.0--alpha.18-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.1.32 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.1.32 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.1.32 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.1.32 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.1.32 |
...
| activiti-cloud-connector.image.tag | string | `"22.2.0-alpha.18"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"22.2.0-alpha.18"` |  |
...
| activiti-cloud-query.image.tag | string | `"22.2.0-alpha.18"` |  |
...
| runtime-bundle.image.tag | string | `"22.2.0-alpha.18"` |  |
