...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 8.8.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 8.8.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 8.8.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 8.8.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-consumer(common) | 8.8.0 |
...
| activiti-cloud-connector.image.tag | string | `"8.8.0"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.8.0"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.8.0"` |  |
...
| runtime-bundle.image.tag | string | `"8.8.0"` |  |
