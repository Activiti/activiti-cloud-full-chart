...
| activiti-cloud-connector.image.tag | string | `"8.6.0-alpha.8"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.6.0-alpha.8"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.6.0-alpha.8"` |  |
...
| runtime-bundle.image.tag | string | `"8.6.0-alpha.8"` |  |
