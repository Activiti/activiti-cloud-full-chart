...
![Version: 8.2.0-alpha.37](https://img.shields.io/badge/Version-8.2.0--alpha.37-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.2.0-alpha.28"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.2.0-alpha.28"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.2.0-alpha.28"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.2.0-alpha.28"` |  |
...
| runtime-bundle.image.tag | string | `"8.2.0-alpha.28"` |  |
