...
![Version: 7.6.0-alpha.15](https://img.shields.io/badge/Version-7.6.0--alpha.15-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.5.0-alpha.6 |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.5.0-alpha.6 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.5.0-alpha.6 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.5.0-alpha.6 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.5.0-alpha.6 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 7.5.0-alpha.6 |
...
| activiti-cloud-connector.image.tag | string | `"7.6.0-alpha.12"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.6.0-alpha.12"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.6.0-alpha.12"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.6.0-alpha.12"` |  |
...
| runtime-bundle.image.tag | string | `"7.6.0-alpha.12"` |  |
