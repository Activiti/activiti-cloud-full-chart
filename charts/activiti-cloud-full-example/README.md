...
![Version: 8.3.0-alpha.20](https://img.shields.io/badge/Version-8.3.0--alpha.20-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.3.0-alpha.20"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.3.0-alpha.20"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.3.0-alpha.20"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.3.0-alpha.20"` |  |
...
| runtime-bundle.image.tag | string | `"8.3.0-alpha.20"` |  |
