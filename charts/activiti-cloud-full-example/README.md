...
![Version: 8.2.0-alpha.16](https://img.shields.io/badge/Version-8.2.0--alpha.16-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.2.0-alpha.11"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.2.0-alpha.11"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.2.0-alpha.11"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.2.0-alpha.11"` |  |
...
| runtime-bundle.image.tag | string | `"8.2.0-alpha.11"` |  |
