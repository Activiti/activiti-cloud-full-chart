...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.14.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.14.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.14.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.14.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 7.14.0 |
...
| activiti-cloud-connector.image.tag | string | `"7.14.0"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.14.0"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.14.0"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.14.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.14.0"` |  |
