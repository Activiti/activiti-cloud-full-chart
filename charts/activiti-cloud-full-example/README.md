...
![Version: 8.4.0-alpha.10](https://img.shields.io/badge/Version-8.4.0--alpha.10-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.4.0-alpha.9"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.4.0-alpha.9"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.4.0-alpha.9"` |  |
...
| runtime-bundle.image.tag | string | `"8.4.0-alpha.9"` |  |
