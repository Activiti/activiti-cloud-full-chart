...
| activiti-cloud-connector.image.tag | string | `"7.1.994"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.1.994"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.1.994"` |  |
...
| activiti-modeling-app.image.tag | string | `"master-931"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.994"` |  |
