...
![Version: 22.2.0-alpha.2](https://img.shields.io/badge/Version-22.2.0--alpha.2-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.1.31 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.1.31 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.1.31 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.1.31 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.1.31 |
...
| activiti-cloud-connector.image.tag | string | `"22.2.0-alpha.2"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"22.2.0-alpha.2"` |  |
...
| activiti-cloud-query.image.tag | string | `"22.2.0-alpha.2"` |  |
...
| runtime-bundle.image.tag | string | `"22.2.0-alpha.2"` |  |
