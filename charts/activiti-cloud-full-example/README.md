...
![Version: 22.2.0-alpha.17](https://img.shields.io/badge/Version-22.2.0--alpha.17-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"22.2.0-alpha.17"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"22.2.0-alpha.17"` |  |
...
| activiti-cloud-query.image.tag | string | `"22.2.0-alpha.17"` |  |
...
| runtime-bundle.image.tag | string | `"22.2.0-alpha.17"` |  |
