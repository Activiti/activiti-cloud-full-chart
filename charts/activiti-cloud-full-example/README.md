...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.1.0-M17.4 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.1.0-M17.4 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.1.0-M17.4 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.1.0-M17.4 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.1.0-M17.4 |
...
| activiti-cloud-connector.image.tag | string | `"7.1.0-M17.4"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.1.0-M17.4"` |  |
...
| activiti-modeling-app.image.tag | string | `"7.1.0-M17.4"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.0-M17.4"` |  |
