...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.5.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.5.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.5.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.5.0-alpha.3 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.5.0-alpha.3 |
...
| activiti-cloud-connector.image.tag | string | `"7.4.0-alpha.26"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.4.0-alpha.26"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.4.0-alpha.26"` |  |
...
| runtime-bundle.image.tag | string | `"7.4.0-alpha.26"` |  |
