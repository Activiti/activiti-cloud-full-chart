...
![Version: 9.0.0-alpha.5](https://img.shields.io/badge/Version-9.0.0--alpha.5-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"9.0.0-alpha.3"` |  |
...
| activiti-cloud-consumer.image.tag | string | `"9.0.0-alpha.3"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"9.0.0-alpha.3"` |  |
...
| activiti-cloud-query.image.tag | string | `"9.0.0-alpha.3"` |  |
...
| runtime-bundle.image.tag | string | `"9.0.0-alpha.3"` |  |
