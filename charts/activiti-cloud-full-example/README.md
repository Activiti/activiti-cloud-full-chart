...
![Version: 7.2.0-alpha.5](https://img.shields.io/badge/Version-7.2.0--alpha.5-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"7.2.0-alpha.5"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.2.0-alpha.5"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.2.0-alpha.5"` |  |
...
| runtime-bundle.image.tag | string | `"7.2.0-alpha.5"` |  |
