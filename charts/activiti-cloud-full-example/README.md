...
![Version: 8.2.0-alpha.21](https://img.shields.io/badge/Version-8.2.0--alpha.21-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.2.0-alpha.16"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.2.0-alpha.16"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.2.0-alpha.16"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.2.0-alpha.16"` |  |
...
| runtime-bundle.image.tag | string | `"8.2.0-alpha.16"` |  |
