...
![Version: 7.4.1-alpha.5](https://img.shields.io/badge/Version-7.4.1--alpha.5-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.4.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.4.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.4.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.4.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.4.0 |
...
| activiti-cloud-connector.image.tag | string | `"7.4.1-alpha.4"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.4.1-alpha.4"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.4.1-alpha.4"` |  |
...
| activiti-modeling-app.image.tag | string | `"7.4.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.4.1-alpha.4"` |  |
