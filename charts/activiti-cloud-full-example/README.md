...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 8.7.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 8.7.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 8.7.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 8.7.1 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-consumer(common) | 8.7.1 |
...
| activiti-cloud-connector.image.tag | string | `"8.7.1"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.7.1"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.7.1"` |  |
...
| runtime-bundle.image.tag | string | `"8.7.1"` |  |
