...
![Version: 8.1.0-alpha.3](https://img.shields.io/badge/Version-8.1.0--alpha.3-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.1.0-alpha.3"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.1.0-alpha.3"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.1.0-alpha.3"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.1.0-alpha.3"` |  |
...
| runtime-bundle.image.tag | string | `"8.1.0-alpha.3"` |  |
