...
![Version: 7.12.0-alpha.6](https://img.shields.io/badge/Version-7.12.0--alpha.6-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.0.0-alpha.5"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.0.0-alpha.5"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.0.0-alpha.5"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.0.0-alpha.5"` |  |
...
| runtime-bundle.image.tag | string | `"8.0.0-alpha.5"` |  |
