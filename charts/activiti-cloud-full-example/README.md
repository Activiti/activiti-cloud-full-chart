...
| activiti-cloud-connector.image.tag | string | `"7.4.0-alpha.18"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.4.0-alpha.18"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.4.0-alpha.18"` |  |
...
| runtime-bundle.image.tag | string | `"7.4.0-alpha.18"` |  |
