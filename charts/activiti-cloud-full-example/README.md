...
| activiti-cloud-connector.image.tag | string | `"7.4.0-alpha.8"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.4.0-alpha.8"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.4.0-alpha.8"` |  |
...
| runtime-bundle.image.tag | string | `"7.4.0-alpha.8"` |  |
