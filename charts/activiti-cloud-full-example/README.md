...
![Version: 7.8.0-alpha.6](https://img.shields.io/badge/Version-7.8.0--alpha.6-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"7.8.0-alpha.4"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.8.0-alpha.4"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.8.0-alpha.4"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.8.0-alpha.4"` |  |
...
| runtime-bundle.image.tag | string | `"7.8.0-alpha.4"` |  |
