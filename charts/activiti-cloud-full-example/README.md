...
| activiti-cloud-connector.image.tag | string | `"8.2.0-alpha.1"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.2.0-alpha.1"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.2.0-alpha.1"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.2.0-alpha.1"` |  |
...
| runtime-bundle.image.tag | string | `"8.2.0-alpha.1"` |  |
