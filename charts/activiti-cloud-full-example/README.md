...
![Version: 8.8.0-alpha.187](https://img.shields.io/badge/Version-8.8.0--alpha.187-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.8.0-alpha.160"` |  |
...
| activiti-cloud-consumer.image.tag | string | `"8.8.0-alpha.160"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.8.0-alpha.160"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.8.0-alpha.160"` |  |
...
| runtime-bundle.image.tag | string | `"8.8.0-alpha.160"` |  |
