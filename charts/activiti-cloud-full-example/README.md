...
![Version: 7.10.0-alpha.25](https://img.shields.io/badge/Version-7.10.0--alpha.25-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.10.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 7.10.0-alpha.2 |
...
| activiti-cloud-connector.image.tag | string | `"7.10.0-alpha.23"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.10.0-alpha.23"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.10.0-alpha.23"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.10.0-alpha.23"` |  |
...
| runtime-bundle.image.tag | string | `"7.10.0-alpha.23"` |  |
