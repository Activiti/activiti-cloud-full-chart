...
![Version: 8.2.0-alpha.20](https://img.shields.io/badge/Version-8.2.0--alpha.20-informational?style=flat-square)
...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 8.2.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 8.2.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 8.2.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 8.2.0-alpha.2 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 8.2.0-alpha.2 |
...
| activiti-cloud-connector.image.tag | string | `"8.2.0-alpha.15"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.2.0-alpha.15"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"8.2.0-alpha.15"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.2.0-alpha.15"` |  |
...
| runtime-bundle.image.tag | string | `"8.2.0-alpha.15"` |  |
