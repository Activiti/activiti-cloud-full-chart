...
![Version: 8.7.0-alpha.62](https://img.shields.io/badge/Version-8.7.0--alpha.62-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.7.0-alpha.60"` |  |
...
| activiti-cloud-consumer.image.tag | string | `"8.7.0-alpha.60"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.7.0-alpha.60"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.7.0-alpha.60"` |  |
...
| runtime-bundle.image.tag | string | `"8.7.0-alpha.60"` |  |
