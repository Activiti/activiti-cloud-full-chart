...
![Version: 7.2.0-alpha.1](https://img.shields.io/badge/Version-7.2.0--alpha.1-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"7.2.0-alpha.1"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.2.0-alpha.1"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.2.0-alpha.1"` |  |
...
| runtime-bundle.image.tag | string | `"7.2.0-alpha.1"` |  |
