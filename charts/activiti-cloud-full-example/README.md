...
![Version: 7.8.0-alpha.17](https://img.shields.io/badge/Version-7.8.0--alpha.17-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"7.8.0-alpha.12"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.8.0-alpha.12"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.8.0-alpha.12"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.8.0-alpha.12"` |  |
...
| runtime-bundle.image.tag | string | `"7.8.0-alpha.12"` |  |
