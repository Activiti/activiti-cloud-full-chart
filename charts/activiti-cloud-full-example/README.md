...
| activiti-cloud-connector.image.tag | string | `"7.9.0"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.9.0"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.9.0"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.9.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.9.0"` |  |
