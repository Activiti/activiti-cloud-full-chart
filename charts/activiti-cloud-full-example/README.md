...
![Version: 7.3.0-alpha.15](https://img.shields.io/badge/Version-7.3.0--alpha.15-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"7.3.0-alpha.15"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.3.0-alpha.15"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.3.0-alpha.15"` |  |
...
| runtime-bundle.image.tag | string | `"7.3.0-alpha.15"` |  |
