...
![Version: 7.6.0-alpha.32](https://img.shields.io/badge/Version-7.6.0--alpha.32-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"7.6.0-alpha.27"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.6.0-alpha.27"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.6.0-alpha.27"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.6.0-alpha.27"` |  |
...
| runtime-bundle.image.tag | string | `"7.6.0-alpha.27"` |  |
