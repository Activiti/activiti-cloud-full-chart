...
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.1.0-M14 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.1.0-M14 |
...
| activiti-cloud-connector.image.tag | string | `"7.1.0-M14"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.1.0-M14"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.1.0-M14"` |  |
...
| activiti-modeling-app.image.tag | string | `"7.1.0-M14"` |  |
...
| runtime-bundle.image.tag | string | `"7.1.0-M14"` |  |
