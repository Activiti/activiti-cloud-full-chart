...
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.2.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.2.0 |
...
| activiti-cloud-connector.image.tag | string | `"7.2.3-alpha.2"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.2.3-alpha.2"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.2.3-alpha.2"` |  |
...
| activiti-modeling-app.image.tag | string | `"7.2.0"` |  |
...
| runtime-bundle.image.tag | string | `"7.2.3-alpha.2"` |  |
