...
![Version: 9.1.0-alpha.76](https://img.shields.io/badge/Version-9.1.0--alpha.76-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"9.1.0-alpha.57"` |  |
...
| activiti-cloud-consumer.image.tag | string | `"9.1.0-alpha.57"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"9.1.0-alpha.57"` |  |
...
| activiti-cloud-query.image.tag | string | `"9.1.0-alpha.57"` |  |
...
| runtime-bundle.image.tag | string | `"9.1.0-alpha.57"` |  |
