...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 9.0.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 9.0.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 9.0.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 9.0.0 |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-consumer(common) | 9.0.0 |
...
| activiti-cloud-connector.image.tag | string | `"9.0.0"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"9.0.0"` |  |
...
| activiti-cloud-query.image.tag | string | `"9.0.0"` |  |
...
| runtime-bundle.image.tag | string | `"9.0.0"` |  |
