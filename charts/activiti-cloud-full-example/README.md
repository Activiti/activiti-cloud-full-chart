...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-modeling-app(common) | 7.7.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 7.7.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 7.7.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 7.7.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-modeling(common) | 7.7.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 7.7.0-mock |
...
| activiti-cloud-connector.image.tag | string | `"7.7.0-mock"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"7.7.0-mock"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"7.7.0-mock"` |  |
...
| activiti-cloud-query.image.tag | string | `"7.7.0-mock"` |  |
...
| activiti-modeling-app.image.tag | string | `"7.7.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"7.7.0-mock"` |  |
