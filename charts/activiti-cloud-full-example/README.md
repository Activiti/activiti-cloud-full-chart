...
|------------|------|---------|
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-query(common) | 8.5.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-connector(common) | 8.5.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | activiti-cloud-identity-adapter(common) | 8.5.0-mock |
| https://activiti.github.io/activiti-cloud-helm-charts | runtime-bundle(common) | 8.5.0-mock |
...
| activiti-cloud-connector.image.tag | string | `"8.5.0-mock"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.5.0-mock"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.5.0-mock"` |  |
...
| runtime-bundle.image.tag | string | `"8.5.0-mock"` |  |
