...
![Version: 8.7.0-alpha.76](https://img.shields.io/badge/Version-8.7.0--alpha.76-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.7.0-alpha.74"` |  |
...
| activiti-cloud-consumer.image.tag | string | `"8.7.0-alpha.74"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.7.0-alpha.74"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.7.0-alpha.74"` |  |
...
| runtime-bundle.image.tag | string | `"8.7.0-alpha.74"` |  |
