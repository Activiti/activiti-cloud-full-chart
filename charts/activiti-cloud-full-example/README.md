...
![Version: 22.2.0-alpha.13](https://img.shields.io/badge/Version-22.2.0--alpha.13-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"22.2.0-alpha.13"` |  |
...
| activiti-cloud-modeling.image.tag | string | `"22.2.0-alpha.13"` |  |
...
| activiti-cloud-query.image.tag | string | `"22.2.0-alpha.13"` |  |
...
| runtime-bundle.image.tag | string | `"22.2.0-alpha.13"` |  |
