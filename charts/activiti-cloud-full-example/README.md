...
![Version: 8.8.0-alpha.115](https://img.shields.io/badge/Version-8.8.0--alpha.115-informational?style=flat-square)
...
| activiti-cloud-connector.image.tag | string | `"8.8.0-alpha.107"` |  |
...
| activiti-cloud-consumer.image.tag | string | `"8.8.0-alpha.107"` |  |
...
| activiti-cloud-identity-adapter.image.tag | string | `"8.8.0-alpha.107"` |  |
...
| activiti-cloud-query.image.tag | string | `"8.8.0-alpha.107"` |  |
...
| runtime-bundle.image.tag | string | `"8.8.0-alpha.107"` |  |
