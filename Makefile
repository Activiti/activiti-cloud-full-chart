...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.169
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.169
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.169
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.169
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.167
MODELING_DEPENDENCIES_VERSION := 7.1.226
