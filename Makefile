...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.156
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.156
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.156
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.156
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.156
ACTIVITI_CORE_DEPENDENCIES_VERSION := 7.1.72
MODELING_DEPENDENCIES_VERSION := 7.1.187
