...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.74
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.73
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.75
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.76
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.74
